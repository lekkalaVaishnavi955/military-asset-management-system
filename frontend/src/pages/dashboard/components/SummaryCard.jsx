...
const SummaryCard = ({ data, onNetMovementClick }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-sky-900 to-indigo-900 text-white rounded-2xl shadow-lg p-6 transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
      <h3 className="text-xl font-bold mb-2 tracking-wide text-amber-400">
