...
axios.defaults.withCredentials = true;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-900 to-sky-950 text-white p-6">
      <h1 className="text-3xl font-bold mb-6">{user?.role?.role_name==='admin'? "Admin":"Base Commander"} Dashboard</h1>

 <div className="w-full bg-gradient-to-br from-blue-900 to-sky-800 p-6 rounded-lg shadow-lg mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
  ...
  <div className="flex gap-2 col-span-full justify-end">
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {showNoData ? (
          <p className="text-yellow-400 text-lg col-span-full">Searching for the data  shortly.</p>
        ) : stats.length === 0 ? (
