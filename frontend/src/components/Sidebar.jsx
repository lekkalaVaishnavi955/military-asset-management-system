...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-blue-900 to-sky-800 p-6 space-y-4 min-h-screen flex flex-col text-white shadow-lg">
      <h2 className="text-xl font-bold border-b border-sky-600 pb-2 mb-6 tracking-wide">Menu</h2>
